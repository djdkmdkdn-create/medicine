...
const validateForm = () => {
  ...
  if (!form.value.password) {
    ...
    errors.value.password = t("validation.minPassword");
  }
...
<template>
  ...
  >
    ...
    <div class="fixed inset-0 pointer-events-none overflow-hidden">
      <div
        class="absolute w-96 h-96 bg-gradient-to-br from-cyan-300/40 to-blue-300/40 rounded-full blur-3xl top-1/4 -right-48"
      ></div>
      <div
        class="absolute w-80 h-80 bg-gradient-to-br from-emerald-300/30 to-teal-300/30 rounded-full blur-3xl bottom-1/4 -left-40"
      ></div>
    </div>
    ...
    <div class="relative w-full max-w-md">
      <div class="card p-8 md:p-10">
        ...
        <div class="text-center mb-8">
          ...
          <p class="text-slate-500 text-sm">Join MyDoctor today</p>
        </div>
          ...
          <div>
            ...
            <div class="relative">
              ...
              <input
                ...
                class="w-full px-4 py-3.5 pl-12 bg-white/70 backdrop-blur-sm border border-slate-200/60 rounded-2xl focus:outline-none focus:ring-2 focus:ring-emerald-400/50 focus:border-emerald-300 focus:bg-white transition-all duration-200"
                :class="{
                  'border-rose-300 focus:ring-rose-400': errors.confirmPassword,
                }"
              />
            </div>
            <p
